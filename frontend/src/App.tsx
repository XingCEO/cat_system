...
import { Moon, Sun, TrendingUp, Flame, Trophy, Activity, Zap, Loader2, Menu, X } from 'lucide-react';
...
const RealtimeMonitorPage = lazy(() => import('@/pages/RealtimeMonitorPage').then(m => ({ default: m.RealtimeMonitorPage })));
...
function NavBar() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full">
            {/* 主導航 - 玻璃態效果 */}
            <div className="mx-4 mt-4 rounded-2xl border border-border/50 bg-card/80 backdrop-blur-xl shadow-lg dark:bg-card/60 dark:border-border/30">
